...
/*
    ...
    /*
        ...
        */
        ...
        {// verilen int degeri aynı satırda bosluk bırakarak yazdırma action yapan seed(tohum) method create edildi
            System.out.print(a + " ");
        }
        ...
        {//seed(tohum) method kendisine verile int degerin cift olmasını kontrol eder
